...
1. `docs/AI事管家_功能规格说明_MVP_v0.2.md` 中对应功能章节。
2. `docs/AI事管家_产品设计说明_MVP_v0.1.md` 中对应页面与状态章节。
3. `docs/AI事管家_整体架构设计_MVP_v0.2.md` 中对应模块、契约和数据流章节。
4. 目标代码模块自己的 `README.md`、共享 Schema 和测试 Fixture。
