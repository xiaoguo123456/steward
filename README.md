...
这不代表所有页面都已正式接入，也不代表已经满足应用商店发布条件。时光已接正式私人媒体链路，亲友已接正式 People API；部分生活场景仍有本地会话或原生设备边界，音乐已退出当前首页信息架构。公开法律页面已形成 1.0 送审稿，仍需公司授权签字、生产阿里云百炼配置和应用商店资料。唯一的全局进度表见 [实现状态](./docs/实现状态.md)。
