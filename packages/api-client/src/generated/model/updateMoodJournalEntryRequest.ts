...
import type { UpdateMoodJournalEntryRequestClearItem } from './updateMoodJournalEntryRequestClearItem';

export interface UpdateMoodJournalEntryRequest {
  clear?: UpdateMoodJournalEntryRequestClearItem[];
  /**
     * @maxLength 120
     * @nullable
     */
