...
公开法律与支持 H5 的版本 1.0、登录前单独同意、“我的”入口、App／Web 账号删除链路和构建门禁已经完成，法律文本已于 2026-09-02 获公司授权确认并允许部署；应用商店资料与外部运营验收仍按上线清单完成。涉及登录、隐私、第三方 SDK／Provider、权限、公开页面、OTA 或商店发布时，必须先阅读 [H5 与公开页面边界](../../docs/H5与公开页面边界.md)。
